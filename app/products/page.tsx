  ...
  *[_type == "post"]{ _id, heading , price , img , img2 , para, para1, para2 }
  ...
  return (
    <div className=" m-2 md:m-0 mt-10 ">
      <div className="w-[250px] ml-2 md:ml-20 ">
        <Breadcrumb>
          <BreadcrumbList>
            <BreadcrumbItem>
      ...
      <div className="flex justify-evenly md:ml-5">
        ...
        <div className="w-[1035px] mt-20">
          <h1 className="font-bold text-[32px] mb-9  text-start md:ml-12">
            Casual
          </h1>
          <div className="flex  flex-wrap md:justify-center gap-8">
            {items.map((item: GivingTypes) => (
              <div key={item._id} className="h-auto md:w-[295px] justify-center items-center  flex flex-col ">
          ...
          <div className="md:flex hidden justify-between border-t-2 border-slate-200 m-10">
            ...
            <div className="mt-5">
              <ul className="flex gap-5 text-slate-400">
                <li className="h-8 w-8 bg-slate-300 text-center rounded-md text-black">
                  1
                </li>
                <li>2</li>
                <li>3</li>
