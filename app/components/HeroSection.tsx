  ...
  return (
    <div className=' h-[780px] bg-[#F2F0F1]'>
        ...
        <div className='absolute z-10 w-[596px] mt-[110px] ml-[90px] space-y-6'>
            <h1 className='font-extrabold  text-7xl'>FIND CLOTHES THAT MATCHES YOUR STYLE</h1>
            <p>Browse through our diverse range of meticulously cratted garments, designed<br/> 
        ...
        <div className='flex justify-center items-center absolute z-10  '>
            ...
            <Image alt='logo' src={shine} className=' ml-[780px] mt-[340px] flex justify-center items-center'/>
        ...
        <div className='h-[122px] whitespace-nowrap bg-black'>
            <ul className='flex justify-center items-center p-10 space-x-28'>
                <li><Image alt='logo' src={versca} /></li>
                <li><Image alt='logo' src={zara}/></li>
                <li><Image alt='logo' src={gucci}/></li>
                <li><Image alt='logo' src={prada}/></li>
                <li><Image alt='logo' src={calvin}/></li>
            </ul>
        </div>
    </div>
