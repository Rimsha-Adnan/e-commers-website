...
const Footer = () => {
  ...
  <div className="relative z-10 mt-[160px] pt-[220px] bg-[#F0F0F0] px-6 md:px-[110px]">
    <div className="flex flex-wrap justify-between items-start space-y-8 md:space-y-0">
      ...
      <div className="w-full md:w-auto md:flex-1 space-y-4">
        ...
        <ul className="flex space-x-3 pt-3">
          <li>
            <Image
              alt="twitter"
              src={twitter}
      ...
      {[
        ...
        <div
          key={index}
          className="w-1/2   md:w-auto mb-6 md:mb-0 space-y-4"
        >
