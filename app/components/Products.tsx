...
const Products = () => {
    ...
    <div className='mt-[50px] h-[650px] space-y-8 border-b-2 w-[1240px] m-auto border-slate-200'>
        ...
        <div>
        <ul>
            <li><Image alt="shirt" src={frm}/></li>
            <li className='font-bold text-[20px] pt-4'>T-SHIRT WITH TAPE DETAILS</li>
        ...
        <div>
        <ul>
            <li><Image alt="shirt" src={frm2}/></li>
            <li className='font-bold text-[20px] pt-4'>SKINNY FIT JEANS</li>
            <li className='flex gap-2 font-normal text-[14px] text-slate-400'><Image alt='star' src={star}/>3.5/5</li>
            <li className='flex space-x-2 font-bold text-[24px]'>$240  <Image alt='logo' src={dollers} className='ml-2 w-[54px] mt-1 h-[26px]'/> <Image alt='logo' src={of} className='ml-2 w-[54px] mt-1 h-[26px]'/></li>
        </ul>
        </div>
        <div>
        <ul>
            <li><Image alt="shirt" src={frm3}/></li>
        ...
        <div>
        <ul>
            <li><Image alt="shirt" src={frm4}/></li>
            <li className='font-bold text-[20px] pt-4'>SLEEVE STRIPED T-SHIRT</li>
            <li className='flex gap-2 font-normal text-[14px] text-slate-400'><Image alt='star' src={star}/>3.5/5</li>
            <li className='flex space-x-2 font-bold text-[24px]'>$130<Image alt='logo' src={doller} className='ml-2 w-[54px] mt-1 h-[26px]'/> <Image alt='logo' src={off} className='h-[28px] w-[58px]'/></li>
        </ul>
        </div>
        </div>
